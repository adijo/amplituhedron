...
export default function Home() {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen py-2 bg-gray-900">
      ...
      <main className="flex flex-col items-center justify-center w-full flex-1 px-20 text-center space-y-8 max-w-screen-xl pb-8 pt-8">
      ...
      <footer className="flex items-center justify-center w-full h-30 border-t border-gray-400 border-opacity-60 pt-8 pb-8 mx-10">
